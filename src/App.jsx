...
export default function App() {
  ...
  // Ref mirror of state so GameCanvas's rAF loop can read the current game state
  // (for the death shake) without triggering React re-renders. Updated
  // synchronously after each render via useEffect.
